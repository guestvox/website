...
function timepicker(element, args) {
    ...
    this.settings = {
        format: true,
        // meridiem: true,
        minTime: new Date(new Date().toDateString() + ' 00:00:00'),
        maxTime: new Date(new Date().toDateString() + ' 24:00:00'),
				onChange: false
    }
    this.active = false
    ...
    this.updateSettings = function(args) {
        ...
        this.settings.minTime = ! (this.settings.minTime.getDate !== undefined || this.settings.minTime.getDate !== null) ? new Date(new Date().toDateString() + ' ' + this.settings.minTime) : new Date(new Date().toDateString() + ' 00:00:00')
    ...
    this.buildTimepicker = function() {
        ...
        // var elements = ['hour', 'minute', 'second', 'meridiem']
        var elements = ['hour', 'minute', 'second']
        ...
        if (! Object.keys(this.elements).length) {
            ...
            for (e = 0; e < elements.length; e++) {
                ...
                this.elements[elements[e]].appendChild(title)
    ...
    this.render = function() {
        ...
        for (e = 0; e < Object.keys(this.elements).length; e++) {
            ...
            if (key == 'hour')
                element.querySelector('.title').innerText = 'Hr'
            if (key == 'minute')
                element.querySelector('.title').innerText = 'Min'
            if (key == 'second')
                element.querySelector('.title').innerText = 'Seg'
            // if (key == 'meridiem')
    ...
    this.buildString = function() {
        ...
        // return (this.getHour() + ":" + this.getMinute() + ":" + this.getSecond() + " " + this.getMeridiem()).trim()
        return (this.getHour() + ":" + this.getMinute() + ":" + this.getSecond()).trim()
    ...
    this.updateBounds = function() {
        ...
        this.timepicker.style.width = (bounds.width - 32) + 'px'
 ...
 *  get
 */
tpicker.updateSettings({minTime: '2:00:00 am'})
