...
$(document).ready(function()
{
    ...
    $('[name="type"]').on('change', function()
    {
        if ($(this).val() == 'many')
        {
            $('form[name="new_room"]').find('[name="prefix"]').parent().parent().parent().removeClass('hidden');
            ...
            $('form[name="new_room"]').find('[name="suffix"]').parent().parent().parent().removeClass('hidden');
            $('form[name="new_room"]').find('[name="name"]').parent().parent().parent().addClass('hidden');
        }
        else if ($(this).val() == 'one')
        {
            $('form[name="new_room"]').find('[name="prefix"]').parent().parent().parent().addClass('hidden');
            ...
            $('form[name="new_room"]').find('[name="suffix"]').parent().parent().parent().addClass('hidden');
    ...
    $('[data-modal="new_room"]').modal().onCancel(function()
    {
        ...
        $('[data-modal="new_room"]').find('[name="prefix"]').parent().parent().parent().removeClass('hidden');
        ...
        $('[data-modal="new_room"]').find('[name="suffix"]').parent().parent().parent().removeClass('hidden');
