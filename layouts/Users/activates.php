...
$this->dependencies->add(['js', '{$path.js}Users/activates.js']);
...
<main>
    <div class="multi-tabs" data-tab-active="tab1">
        <ul>
            ...
            <li data-tab-target="tab1" class="active"><a href="/users/activates">{$lang.activates}</a></li>
            <?php endif; ?>
            <?php if (Functions::check_access(['{users_activate}']) == true) : ?>
            <li data-tab-target="tab2"><a href="/users/deactivates">{$lang.deactivates}</a></li>
            <?php endif; ?>
            <?php if (Functions::check_access(['{userlevels_create}','{userlevels_update}','{userlevels_delete}']) == true) : ?>
            <li data-tab-target="tab3"><a href="/users/permissions">{$lang.user_permissions}</a></li>
            <?php endif; ?>
        </ul>
        <?php if (Functions::check_access(['{users_create}','{users_update}','{users_restorepassword}','{users_deactivate}','{users_delete}']) == true) : ?>
