...
$this->dependencies->add(['css', '{$path.css}Hi/menu.css']);
$this->dependencies->add(['js', '{$path.js}Hi/menu.js']);
...
<main class="landing_page_menu">
    <section id="section_one" class="gradient hand_background">
        <div class="container">
            <figure class="logotype">
                <img src="{$path.images}hi/menu/logotype_color.png" alt="Guestvox">
            </figure>
            <div class="content">
                <h3>{$lang.landing_page_hi_menu_text_1}</h3>
                <p>{$lang.landing_page_hi_menu_text_2}</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="content">
                <div>
                    ...
                    <div class="box">
                        <p>{$lang.landing_page_hi_menu_text_3}</p>
                    </div>
                </div>
                <div>
                    <span class="st_2_img_2"></span>
                    <div class="box">
                        <p>{$lang.landing_page_hi_menu_text_4}</p>
                    </div>
                </div>
                <div>
                    <span class="st_2_img_3"></span>
                    <div class="box">
                        <p>{$lang.landing_page_hi_menu_text_5}</p>
                    </div>
                </div>
            </div>
            <div class="space50"></div>
    ...
    <!-- <section id="section_three">
        <div class="container">
            ...
            <figure>
                <img src="{$path.images}hi/menu/st_3_img_1.png" alt="Background">
            </figure>
        </div>
        <span class="st_2_img_1"></span>
    </section> -->
    <section id="section_four">
        ...
        <span>{$lang.landing_page_hi_menu_text_8}<span class="st_2_img_1"></span></span>
    </section>
