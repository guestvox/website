...
$this->dependencies->add(['css', '{$path.css}Hi/hospitals.css']);
$this->dependencies->add(['js', '{$path.js}Hi/hospitals.js']);

?>

<header class="landing_page_hospitals">
...
<main class="landing_page_hospitals">
    <section id="section_one" class="gradient hand_background">
        <div class="container">
            <figure class="logotype">
                <img src="{$path.images}hi/hospitals/logotype_color.png" alt="Guestvox">
            </figure>
            <div class="content">
                <h3>{$lang.landing_page_hi_hospitals_text_1}</h3>
                <p>{$lang.landing_page_hi_hospitals_text_2}</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="content">
                <div>
                    ...
                    <div class="box">
                        <p>{$lang.landing_page_hi_hospitals_text_3}</p>
                    </div>
                </div>
                <div>
                    <span class="st_2_img_2"></span>
                    <div class="box">
                        <p>{$lang.landing_page_hi_hospitals_text_4}</p>
                    </div>
                </div>
                <div>
                    <span class="st_2_img_3"></span>
                    <div class="box">
                        <p>{$lang.landing_page_hi_hospitals_text_5}</p>
                    </div>
                </div>
            </div>
            <div class="space50"></div>
    ...
    <section id="section_three">
        <div class="container">
            <h3>{$lang.landing_page_hi_hospitals_text_6}</h3>
            <figure>
                <img src="{$path.images}hi/hospitals/st_3_img_1.png" alt="Background">
            </figure>
        </div>
        <span class="st_2_img_1"></span>
    </section>
    <section id="section_four">
        <div class="container">
            <h3>{$lang.landing_page_hi_hospitals_text_7}</h3>
        </div>
        <span>{$lang.landing_page_hi_hospitals_text_8}<span class="st_2_img_1"></span></span>
    </section>
    <section id="section_five">
        <div class="container">
            <h5>{$lang.landing_page_hi_hospitals_text_9}</h5>
            <div>
                <img src="{$path.images}hi/hospitals/pantalla_ipad.png" alt="Background">
                <div class="content">
                    <h3>{$lang.landing_page_hi_hospitals_text_10}</h3>
                    <a data-button-modal="contact" class="btn">{$lang.request_your_demo}</a>
                </div>
            </div>
        </div>
    ...
    <section id="section_six">
        <div class="container">
            <h3>{$lang.landing_page_hi_hospitals_text_11}</h3>
        </div>
    </section>
    <section id="section_seven">
        <div class="container">
            <h3>{$lang.landing_page_hi_hospitals_text_12}</h3>
            <img src="{$path.images}hi/hospitals/graficas.png" alt="Background">
        </div>
    </section>
    <section id="section_eight">
        <div class="container">
            <h3>{$lang.landing_page_hi_hospitals_text_13}</h3>
            <p>{$lang.landing_page_hi_hospitals_text_14}</p>
        </div>
    </section>
    <section id="section_nine" class="gradient_c_r">
        <div class="container">
            <div class="content">
                ...
                <h4>{$lang.landing_page_hi_hospitals_text_15}</h4>
                <p>{$lang.landing_page_hi_hospitals_text_16}</p>
            </div>
            <h3>{$lang.landing_page_hi_hospitals_text_17}</h3>
        </div>
    </section>
