...
$this->dependencies->add(['css', '{$path.css}Hi/hotels.css']);
$this->dependencies->add(['js', '{$path.js}Hi/hotels.js']);
...
<main class="landing_page_hotels">
    <section id="section_one" class="gradient hand_background">
        <div class="container">
            <figure class="logotype">
                <img src="{$path.images}hi/hotels/logotype_color.png" alt="Guestvox">
            </figure>
            <div class="content">
                <h3>{$lang.landing_page_hi_hotels_text_1}</h3>
                <p>{$lang.landing_page_hi_hotels_text_2}</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="content">
                <div>
                    ...
                    <div class="box">
                        <p>{$lang.landing_page_hi_hotels_text_3}</p>
                    </div>
                </div>
                <div>
                    <span class="st_2_img_2"></span>
                    <div class="box">
                        <p>{$lang.landing_page_hi_hotels_text_4}</p>
                    </div>
                </div>
                <div>
                    <span class="st_2_img_3"></span>
                    <div class="box">
                        <p>{$lang.landing_page_hi_hotels_text_5}</p>
                    </div>
                </div>
            </div>
            <div class="space50"></div>
    ...
    <section id="section_three">
        <div class="container">
            ...
            <figure>
                <img src="{$path.images}hi/hotels/st_3_img_1.png" alt="Background">
            </figure>
        </div>
        <span class="st_2_img_1"></span>
    </section>
    <section id="section_four">
        ...
        <span>{$lang.landing_page_hi_hotels_text_8}<span class="st_2_img_1"></span></span>
    </section>
    ...
    <section id="section_nine" class="gradient_c_r">
        <div class="container">
            ...
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://guestvox.com/hotrestaurant/survey" alt="QR">
                <h4>{$lang.landing_page_hi_hotels_text_15}</h4>
                <p>{$lang.landing_page_hi_hotels_text_16}</p>
            </div>
            <h3>{$lang.landing_page_hi_hotels_text_17}</h3>
        </div>
    </section>
