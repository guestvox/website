	...
	public function index()
	{
					...
					if (!empty($query))
					{
						...
						foreach ($this->model->get_survey_questions() as $value)
						{
							...
							'<tr>
								...
								<td align="right" class="icon"><a data-action="add_survey_subquestion" data-id="' . $value['id'] . '"><i class="fas fa-plus-square"></i></a></td>
								<td align="right" class="icon">' . (($value['fk'] == false) ? '<a data-action="delete_survey_question" data-id="' . $value['id'] . '"><i class="fas fa-trash"></i></a>' : (($value['status'] == true) ? '<a data-action="deactivate_survey_question" data-id="' . $value['id'] . '"><i class="fas fa-ban"></i></a>' : '<a data-action="activate_survey_question" data-id="' . $value['id'] . '"><i class="fas fa-check"></i></a>'))
								. '</td>
		...
		else
		{
			...
			foreach ($this->model->get_survey_questions() as $value)
			{
				$tbl_survey_questions .=
				'<tr>
					<td align="left"><i class="fas fa-arrow-right"></i> ' . $value['q1']['question'][Session::get_value('settings')['language']] . '</td>
					<td align="left">' . (($value['q1']['status'] == true) ? 'Activada' : 'Desactivada') . '</td>
					<td align="right" class="icon"><a data-action="add_survey_subquestion" data-id="' . $value['q1']['id'] . '"><i class="fas fa-plus-square"></i></a></td>
					<td align="right" class="icon">' . (empty($value['q1']['subquestions']) ? '<a data-action="delete_survey_question" data-id="' . $value['q1']['id'] . '"><i class="fas fa-trash"></i></a>' : (($value['q1']['status'] == true) ? '<a data-action="deactivate_survey_question" data-id="' . $value['q1']['id'] . '"><i class="fas fa-ban"></i></a>' : '<a data-action="activate_survey_question" data-id="' . $value['q1']['id'] . '"><i class="fas fa-check"></i></a>'))
					 . '</td>
					<td align="right" class="icon"><a data-action="edit_survey_question" data-id="' . $value['q1']['id'] . '"><i class="fas fa-pencil-alt"></i></a></td>
				</tr>';
