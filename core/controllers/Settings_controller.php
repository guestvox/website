...
class Settings_controller extends Controller
{
	...
	public function opportunityareas()
	{
		if (Format::exist_ajax_request() == true)
		{
			if ($_POST['action'] == 'get_opportunity_area')
		...
		{
			define('_title', 'GuestVox | Áreas de oportunidad');

			$template = $this->view->render($this, 'opportunityareas');
	...
	public function opportunitytypes()
	{
		...
		{
			define('_title', 'GuestVox | Tipos de oportunidad');

			$template = $this->view->render($this, 'opportunitytypes');
	...
	public function locations()
	{
		...
		{
			define('_title', 'GuestVox | Ubicaciones');
	...
	public function rooms()
	{
		...
		{
			define('_title', 'GuestVox | Habitaciones');

			$template = $this->view->render($this, 'rooms');
	...
	public function guesttreatments()
	{
		if (Format::exist_ajax_request() == true)
		{
			// ---
		...
		else
		{
			...
			$template = $this->view->render($this, 'guesttreatments');
	...
	public function guesttypes()
	{
		...
		{
			define('_title', 'GuestVox | Tipo de huésped');

			$template = $this->view->render($this, 'guesttypes');
	...
	public function reservationstatus()
	{
		...
		{
			define('_title', 'GuestVox | Estatus de reservación');

			$template = $this->view->render($this, 'reservationstatus');
