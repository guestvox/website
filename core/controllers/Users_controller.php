...
class Users_controller extends Controller
{
	...
	public function activates()
	{
		...
		{
			define('_title', 'GuestVox | Activos');

			$template = $this->view->render($this, 'activates');
	...
	public function deactivates()
	{
		...
		{
			define('_title', 'GuestVox | Inactivos');

			$template = $this->view->render($this, 'deactivates');
	...
	public function userspermissions()
	{
		...
		{
			define('_title', 'GuestVox | Permiso de usuarios');

			$template = $this->view->render($this, 'userspermissions');
