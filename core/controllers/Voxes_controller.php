		...
		if (!empty($vox))
		{
			...
			else
			{
				...
				$replace = [
					...
					'{$btn_start_vox}' => ($vox['status'] == true AND $vox['automatic_start'] == true) ? ($vox['started_date'] == null) ? '<a class="big new" data-button-modal="start_vox"><i class="fas fa-play-circle"></i><span>Iniciar</span></a>' : '' : '',
